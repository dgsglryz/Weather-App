...
class CityViewController: UIViewController {
  ...
  @objc func showWeatherDetails() {
    let detailsViewController = DetailsOfViewController()
    detailsViewController.countryLabel.text = city.country
    detailsViewController.countryLabel.text = city.flag
    detailsViewController.cityName.text = city.name
    detailsViewController.tempName.text = String(city.temp)
    detailsViewController.SumName.text = city.summary
