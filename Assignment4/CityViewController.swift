...
class CityViewController: UIViewController {
  ...
  @objc func showWeatherDetails() {
      ...
      detailsViewController.weatherDescription = city.summary
      detailsViewController.currentTemperature = String(city.temp)
      detailsViewController.chanceOfPrecipitation = String(city.precipitation)
